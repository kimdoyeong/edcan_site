import circles1 from "../../../assets/image/portfolio/circles_1.jpg";
import circles2 from "../../../assets/image/portfolio/circles_2.jpg";
import Atti from "../../../assets/image/portfolio/atti.jpg";
...
import space from "../../../assets/image/portfolio/space.png";
const portfolioList = [
  {
    name: "circles.",
    members: "김현우, 표영우, 김태양",
  ...
  },
  {
    name: "스페이스 (Space)",
    members: "김도영, 김민, 정찬효",
    prize: "디지털콘텐츠 개발대회 동상",
    description: "빠르고 편리한 공유경제 마켓 플랫폼",
    images: [space],
  },
